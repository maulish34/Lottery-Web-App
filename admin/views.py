...
def view_winning_draw():
    ...
    current_winning_draw = Draw.query.filter_by(
        master_draw=True, been_played=False
    ).first()
    ...
    if current_winning_draw:
        ...
        make_transient(current_winning_draw)
        current_winning_draw.numbers = current_winning_draw.view_draw(
        ...
        return render_template(
            "admin/admin.html",
            winning_draw=current_winning_draw,
        ...
        if user_draws:
            ...
            for draw in user_draws:
                ...
                if draw.numbers == current_winning_draw.numbers:
                    ...
                    results.append(
                        (
                            current_winning_draw.lottery_round,
                            draw.numbers,
                            draw.user_id,
                            user.email,
                        )
            ...
            return render_template(
                "admin/admin.html", results=results, name=current_user.firstname
            )
...
def view_all_users():
    ...
    return render_template(
        "admin/admin.html", name=current_user.firstname, current_users=current_users
    )
...
def logs():
    ...
    return render_template(
        "admin/admin.html", logs=content, name=current_user.firstname
    )
...
def view_user_activity():
    ...
    print(content)
    return render_template(
        "admin/admin.html", name=current_user.firstname, content=content
    )
